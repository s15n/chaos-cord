        ...
        return (
            ...
            <section style={{
                ...
                <div style={{
                    ...
                    <SearchBar/>
                    <ButtonIcon toggle={true} onClick={toggleMemberListVisible}>
...
const ButtonIcon = ({onClick, toggle, children}: {onClick?: ButtonClickListener, toggle?: boolean, children?: any}) => {
    return <Button style={iconWrapperStyle} baseColor='#c0c0c0' overColor='#dddddd' activeColor='#f7f7f7' onClick={onClick} toggle={toggle} active={toggle}>{children}</Button>
}
