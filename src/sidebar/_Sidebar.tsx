...
const Sidebar: React.FC = () => {
    ...
    return (
        <div id="Sidebar">
            <GuildOverview/>
            <UserInfo/>
            {discordState.voice ? <VoiceInfo currentVoice={discordState.voice}/> : null}
        </div>
    )
}
...
const GuildOverview: React.FC = () => {
    ...
    const guild = discordState.guild

    return (
        <nav id="GuildInfo">
            <div>
                {guild ? <GuildInfo guild={guild}/> : null }
            </div>
            <div/>
            {
                guild
                ? <Channels guild={guild} selectedChannel={discordState.channel ?? undefined}/>
                : <MainPage/>
            }
        </nav>
    )
...
const GuildInfo: React.FC<GuildInfoProps> = ({ guild }) => {
